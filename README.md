This is an arduino based team project which is used to develop an input/output clock system which takes i/p in form of buttons provided in user interface and gives 
